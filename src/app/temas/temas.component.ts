...
export class TemaComponent implements OnInit {
  ...
  @ViewChild('frame', { static: true }) basicModal: TemaComponent;
  constructor(
  ...
  validarTema(): boolean {
    ...
    if (this.util.isStringVacio(this.tema.contenido)) {
       this.msg.msgWarningmodal('INGRESE CONTENIDO DEL TEMA',false);
      valido = false;
    ...
    if (valido) {
      ...
      if (valido2) {
        ...
        if (this.modo == 'REG') {
          ...
          this._spinnerService.hide();
          this.msg.msgSuccess("¡Tema se modificó exitosamente!");
        }
      }
